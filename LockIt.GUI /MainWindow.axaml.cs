...
public partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    {
        if (string.IsNullOrWhiteSpace(Service) || string.IsNullOrWhiteSpace(Email) ||
            string.IsNullOrWhiteSpace(PasswordDisplay))
        {
            StatusMessage = "⚠️ Please fill in all required fields!";
            return;
        }
        ...
        try
        {
            ...
            StatusMessage = "✅ Credential saved successfully!";
            Service = "";
            Email = "";
            Notes = "";
        }
        ...
        {
            StatusMessage = $"❌ Error saving credential: {ex.Message}";
        }
    }
}